...
return [
    ...
    'messages' => [
        ...
        'save_summary_intro' => 'Вот что запишу в карточку авто:',
        'save_summary_outro' => 'Если всё верно — нажмите «Записать». Если нет — напишите, что исправить.',
        'save_work_summary_intro' => 'Вот что запишу в журнал работ:',
        'save_work_summary_outro' => 'Если всё верно — нажмите «Записать». Если нет — напишите, что исправить.',
